...
def analyze_session_table(sessiondata, numdisplayed):
	...
	if FLAGS.srcip:
		#added by dkv >
		srcdic={}
		srcdic={"Number of Connections":[],"IP Address":[]}
		#< added by dkv
		...
		for i,j in srcipl[:numdisplayed]:
			...
			srcdic["Number of Connections"].append(pp)
			srcdic["IP Address"].append(i)
		srcjson=json.dumps(srcdic, indent=4)
		#print(srcjson)
		#print(srcdic)
		#return(srcdic)
		#print("\n")
		res=json.loads(srcjson)
		
		
		print("\n")

		srcIpx=res['Number of Connections']
		srcIpy=res['IP Address']
		dictsrcIp=[srcIpx,srcIpy]
		file = open("resSrcIp.txt", "w")
		file.write(repr(dictsrcIp))
		file.close
		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		finsrcjson=[dict(zip(keys, v)) for v in vals]
		print(finsrcjson)
		print("\n")
		print("\n")
	...
	if FLAGS.dstip:
		#added by dkv >
		dstdic={}
		dstdic={"Number of Connections":[],"IP Address":[]}
		#< added by dkv
		...
		for i,j in dstipl[:numdisplayed]:
			...
			dstdic["Number of Connections"].append(pp)
			dstdic["IP Address"].append(i)
		dstjson=json.dumps(dstdic, indent=4)
		#print(dstjson)
		# # print("\n")
		res=json.loads(dstjson)
		#print(res)

		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		findstjson=[dict(zip(keys, v)) for v in vals]
		# f1=open("jsonDstIPOutput.txt","w")
		# f1.write(repr(findstjson))
		print(findstjson)
		# filedstjson=json.dumps(findstjson)
		# with open('json_dstip.json','w') as outfile:
		# 	data=json.load(filedstjson,outfile)
		# print(data)
		# # print("\n")
		# # print("\n")
		#print(dstdic)
	...
	if FLAGS.srcport:
		srcportdic={}
		#srcportdic={"Number of Connections":[],"Port":[],"Possible Service":[]}
		srcportdic={"Number of Connections":[],"Port":[]}
		#< added by dkv
		...
		for i,j in srcportl[:numdisplayed]:
			...
			# 	srcportdic["Number of Connections"].append(pp)
			# 	srcportdic["Port"].append(i)
			# 	srcportdic["Possible Service"].append(portnum[int(i)])
			# except:
				#print("%s    \t\t\t-    %s   (Not listed) (%s Percent)"%(pp, i, round(source_ports_percent*100,2) ))
			srcportdic["Number of Connections"].append(pp)
			srcportdic["Port"].append(i)
		srcportjson=json.dumps(srcportdic, indent=4)
		...
		print("\n")
		res=json.loads(srcportjson)
		#print(res)

		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		finsrcportjson=[dict(zip(keys, v)) for v in vals]
		print(finsrcportjson)
		print("\n")
		print("\n")
		# #print(dstdic)
	...
	if FLAGS.dstport:
		#added by dkv >
		dstportdic={}
		dstportdic={"Number of Connections":[],"Port":[]}
		#< added by dkv
		...
		for i,j in destportl[:numdisplayed]:
			...
			dstportdic["Number of Connections"].append(pp)
			dstportdic["Port"].append(i)
				#dstportdic["Possible Service"].append(portnum[int(i)])
			
		dstportjson=json.dumps(dstportdic, indent=4)
		#print(dstportjson)
		#print(dstportdic)
		#return(dstportdic)
		print("\n")
		res=json.loads(dstportjson)
		#print(res)

		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		findstportjson=[dict(zip(keys, v)) for v in vals]
		print(findstportjson)
		print("\n")
		print("\n")

	if FLAGS.protocol:
		protodic={}
		protodic={"Number of Connections":[],"Protocol":[]}
		...
		for i,j in protocoll[:numdisplayed]:
			...
			try:
				...
				protodic["Number of Connections"].append(pp)
				protodic["Protocol"].append(i)
			except:
				#print("%s    \t\t-       %s    (%s Percent)" %(pp, i, round(protocol_percent*100, 2)))
				protodic["Number of Connections"].append(pp)
				protodic["Protocol"].append(i)
		protojson=json.dumps(protodic, indent=4)
		#print(protojson)
		#print(protodic)
		#return(protodic)
		print("\n")
		
		res=json.loads(protojson)
		#print(res)

		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		finprotojson=[dict(zip(keys, v)) for v in vals]
		print(finprotojson)
		print("\n")
		print("\n")
		#print(dstdic)
	...
	if FLAGS.policy:
		policydic={}
		policydic={"Number of Connections":[],"Policy":[]}
		...
		for i,j in policyl[:numdisplayed]:
			...
			policydic["Number of Connections"].append(pp)
			policydic["Policy"].append(i)
		policyjson=json.dumps(policydic, indent=4)
		#print(policyjson)
		#print(policydic)
		#return(policydic)
		print("\n")

		res=json.loads(policyjson)
		#print(res)

		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		finpolicyjson=[dict(zip(keys, v)) for v in vals]
		print(finpolicyjson)
		print("\n")
		print("\n")
		#print(dstdic)
	...
	if FLAGS.interface:
		interfacedic={}
		interfacedic={"Number of Connections":[],"Interface":[]}
		...
		for i,j in interfacel[:numdisplayed]:
			...
			interfacedic["Number of Connections"].append(pp)
			interfacedic["Interface"].append(i)
		interfacejson=json.dumps(interfacedic, indent=4)
		#print(interfacejson)
		#print(interfacedic)
		#return(interfacedic)
		print("\n")

		res=json.loads(interfacejson)
		#print(res)

		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		fininterfacejson=[dict(zip(keys, v)) for v in vals]
		print(fininterfacejson)
		print("\n")
		print("\n")
		#print(dstdic)
		#return(finsrcjson)
	...
	if FLAGS.packet:
		packetdic={}
		packetdic={"Source IP":[],"Destination IP":[],"Source Port":[],"Destination Port":[],"Packets":[]}
		...
		for line in xferlist[:numdisplayed]:
			...
			packetdic["Source IP"].append(line[1])
			packetdic["Destination IP"].append(line[2])
			packetdic["Source Port"].append(line[3])
			packetdic["Destination Port"].append(line[4])
			packetdic["Packets"].append(line[0])
		packetjson=json.dumps(packetdic, indent=4)
		#print(packetjson)
		#print(packetdic)
		#return(packetdic)
		print("\n")

		res=json.loads(packetjson)
		#print(res)

		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		finpacketjson=[dict(zip(keys, v)) for v in vals]
		print(finpacketjson)
		print("\n")
		print("\n")
		#print(dstdic)
	...
	if FLAGS.bytes:
		bytesdic={}
		bytesdic={"Source IP":[],"Destination IP":[],"Source Port":[],"Destination Port":[],"Bytes":[]}
		...
		for line in xferbytelist[:numdisplayed]:
			pp = int(len(line))
			#print("%s \t\t %s \t\t %s \t\t\t %s \t\t %s \n"%(line[1],line[2], line[3], line[4], line[0]))
			bytesdic["Source IP"].append(line[1])
			bytesdic["Destination IP"].append(line[2])
			bytesdic["Source Port"].append(line[3])
			bytesdic["Destination Port"].append(line[4])
			bytesdic["Bytes"].append(line[0])
		bytesjson=json.dumps(bytesdic, indent=4)
		#print(bytesjson)
		#print(bytesdic)
		#return(bytesdic)
		print("\n")

		res=json.loads(bytesjson)
		#print(res)

		keys=res.keys()
		vals=zip(*[res[k] for k in keys])
		finbytesjson=[dict(zip(keys, v)) for v in vals]
		print(finbytesjson)
		print("\n")
		print("\n")
		#print(dstdic)
		#return(finsrcjson)
	#return(connectionCount,inCount,outCount)
	#return(srcjson,dstjson,srcportjson,dstportjson,protojson,policyjson,interfacejson,packetjson,bytesjson)
	#print("Connection Count: ",connectionCount,"\nIn Count: ",inCount,"\nOut Count: ",outCount)
	#printData.parseMetricsGraph(connectionCount,inCount,outCount)
	totalConnections=connectionCount
	successConnections=outCount
	destroyedConnections=inCount-outCount
	#print("Success Connections: ",successConnections,"\tDestroyed Connections: ",destroyedConnections)
	#printData.saveGraphValues(totalConnections,successConnections,destroyedConnections)
	#printData.display_chart()
	#app.parsedGraphValues(totalConnections,successConnections,destroyedConnections)
	conn={}
	conn['TotalConnections']=totalConnections
	conn['SuccessConnections']=successConnections
	conn['DestroyedConnections']=destroyedConnections
	#print(conn)
	graphData=[successConnections,destroyedConnections]
	f=open("graphVal.txt","w")
	f.write(repr(graphData))
